...
The web app lives at `gimme-golf-rust.vercel.app` (production). Source is in this repo. You'll want to play with it before reading further — five minutes on the PWA explains more than any spec.
